    ...
    <section className="py-24 bg-slate-900 border-t border-white/5">
      <div className="max-w-7xl mx-auto px-6 lg:px-8">
        <div className="text-center max-w-3xl mx-auto mb-16">
          <h2 className="text-3xl md:text-5xl font-extrabold text-white tracking-tight">Loved by top teams</h2>
          <p className="mt-4 text-lg text-slate-400">See what our users are saying about GridLancer.</p>
        </div>
        
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
          <div className="bg-slate-800/50 backdrop-blur-sm border border-slate-700 rounded-3xl p-8 flex flex-col justify-between">
          ...
          <div className="bg-slate-800/50 backdrop-blur-sm border border-slate-700 rounded-3xl p-8 flex flex-col justify-between md:hidden lg:flex">
            <p className="text-slate-300 leading-relaxed mb-8">
